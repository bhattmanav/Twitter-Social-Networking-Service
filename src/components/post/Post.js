...
const Post = forwardRef(
  ({ name, username, verified, timestamp, text, image, avatar }, ref) => {
    return (
      <div className="post" ref={ref}>
        ...
        <div className="post__body">
          ...
          <div className="post__footer">
            <ChatBubbleOutlineIcon cursor="pointer" fontSize="small" />
            <RepeatIcon cursor="pointer" fontSize="small" />
            <FavoriteBorderIcon cursor="pointer" fontSize="small" />
